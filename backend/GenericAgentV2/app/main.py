...
configure_logging(service="generic_agent_v2")
logger = logging.getLogger(__name__)


@asynccontextmanager
async def lifespan(app: FastAPI):
    logger.info("GenericAgentV2 starting — loading data-aware agent definitions")
...
app = FastAPI(title="GenericAgentV2", lifespan=lifespan)
